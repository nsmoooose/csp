#ifndef __TOWEDARTILLERY_H__
#define __TOWEDARTILLERY_H__
...
class TowedArtillery : public GroundVehicle
{
  // Methods
 public:

  TowedArtillery();
  virtual ~TowedArtillery();

  TowedArtillery(const TowedArtillery &);
  TowedArtillery & operator=(const TowedArtillery &);
