...
namespace SpatialIndex
{
	namespace RTree
	{
		...
		typedef PoolPointer<IEntry> IEntryPtr;
		typedef PoolPointer<Node> NodePtr;
		typedef PoolPointer<Leaf> LeafPtr;
		typedef PoolPointer<Index> IndexPtr;
		...
		public:
			...
			virtual long getChildIdentifier(unsigned long index)  const throw (IndexOutOfBoundsException);
			virtual void getChildShape(unsigned long index, IShape** out)  const throw (IndexOutOfBoundsException, std::exception);
