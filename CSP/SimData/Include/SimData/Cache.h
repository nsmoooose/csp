...
#ifndef __SIMDATA_CACHE_H__
#define __SIMDATA_CACHE_H__
 ...
 */
template <typename KEY, typename TYPE, typename HASH_METHOD = HASH<KEY> >
class MostRecentlyUsedCache {
	...
	typedef HASH_MAP<CacheKey, CacheElement, HASH_METHOD> CacheMap;
