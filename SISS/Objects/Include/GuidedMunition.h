#ifndef __GUIDEDMUNITION_H_
#define __GUIDEDMUNITION_H_
...
class GuidedMunition : public Munition
{
 public:
 ...
 public:
  ...
  GuidedMunition();
  virtual ~GuidedMunition();

  GuidedMunition(const GuidedMunition &);
  GuidedMunition & operator=(const GuidedMunition &);
