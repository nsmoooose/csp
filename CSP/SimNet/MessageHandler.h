...
public:
	...
	static inline Ref Callback(CLASS *instance, void (CLASS::*method)(NetworkMessage::Ref const &));
...
public:
	typedef void (CLASS::*Method)(NetworkMessage::Ref const &);
	CallbackHandler(CLASS *instance, Method method): m_Instance(instance), m_Method(method) { }
	virtual void handleMessage(NetworkMessage::Ref const &message) { (m_Instance->*m_Method)(message); }
private:
	CLASS *m_Instance;
	Method m_Method;
};
...
template <class CLASS>
inline MessageHandler::Ref MessageHandler::Callback(CLASS *instance, void (CLASS::*method)(NetworkMessage::Ref const &)) {
