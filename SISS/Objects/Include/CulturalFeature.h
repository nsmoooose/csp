#ifndef __CULTURALFEATURE_H__
#define __CULTURALFEATURE_H__
...
class CulturalFeature : public PhysicalEntity
{
 ...
 public:
  ...
  CulturalFeature(const CulturalFeature &);
  CulturalFeature & operator=(const CulturalFeature &);
