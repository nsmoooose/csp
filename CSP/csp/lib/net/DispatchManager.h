 ...
 * and use the CSPNET_DISPATCH macros to associate handlers with
...
#include <csp/lib/net/Callbacks.h>
#include <csp/lib/net/DispatchCache.h>
...
public:
	 ...
	 */
	DispatchManager(Ref<MessageQueue> queue, unsigned cache_size);

	/** Dispatch a message to a specific handler.
	 *
	 *  This is a quasi-internal method used by the CSPNET_DISPATCH macro.
	 ...
	 *
	 *  This is a quasi-internal method used by the CSPNET_DECLARE_DISPATCH
