 ...
 * @author Mark Rose <mkrose@users.sf.net>
 */
class SIMDATA_EXPORT Interpolation {
public:
...
SIMDATA_EXPORT std::ostream &operator <<(std::ostream &o, Table1 const &t);
SIMDATA_EXPORT std::ostream &operator <<(std::ostream &o, Table2 const &t);
SIMDATA_EXPORT std::ostream &operator <<(std::ostream &o, Table3 const &t);
