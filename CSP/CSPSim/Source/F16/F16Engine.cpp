...
SIMDATA_XML_BEGIN(F16Engine)
	SIMDATA_DEF("wind_spin", m_WindSpin, false)
	SIMDATA_DEF("drag_rate", m_DragRate, false)
	SIMDATA_DEF("fan_turbine_inlet__heat_rate", m_FanTurbineInletHeatRate, false)
	SIMDATA_DEF("fan_turbine_inlet_cool_rate", m_FanTurbineInletCoolRate, false)
	SIMDATA_DEF("fan_turbine_inlet_temperature_base", m_FanTurbineInletTemperatureBase, false)
	SIMDATA_DEF("fan_turbine_inlet_temperature_scale", m_FanTurbineInletTemperatureScale, false)
	SIMDATA_DEF("core_fan_turbine_inlet_temperature_ratio", m_CoreFanTurbineInletTemperatureRatio, false)
	SIMDATA_DEF("core_heat_rate", m_CoreHeatRate, false)
	SIMDATA_DEF("core_cool_rate", m_CoreCoolRate, false)
	SIMDATA_DEF("exhaust_heat_rate", m_ExhaustHeatRate, false)
	SIMDATA_DEF("exhaust_cool_rate", m_ExhaustCoolRate, false)
	SIMDATA_DEF("friction", m_Friction, false)
	SIMDATA_DEF("spindown_tau", m_SpinDownTau, false)
	SIMDATA_DEF("spool_rate", m_SpoolRate, false)
	SIMDATA_DEF("abnormal_start_chance", m_AbnormalStartChance, false)
	SIMDATA_DEF("hot_delta", m_HotDelta, false)
	SIMDATA_DEF("overheat", m_Overheat, false)
	SIMDATA_DEF("idle_rpm", m_IdleRPM, false)
	SIMDATA_DEF("afterburner_rpm", m_AfterburnerRPM, false)
	SIMDATA_DEF("afterburner_delay", m_AfterburnerDelay, false)
	SIMDATA_DEF("afterburner_min_rpm", m_AfterburnerMinRPM, false)
	SIMDATA_DEF("afterburner_cutoff_rpm", m_AfterburnerCutoffRPM, false)
	SIMDATA_DEF("idle_fuel_consumption", m_IdleFuelConsumption, false)
	SIMDATA_DEF("min_ftit_ignition", m_MinFTITIgnition, false)
	SIMDATA_DEF("nozzle_idle_factor", m_NozzleIdleFactor, false)
	SIMDATA_DEF("nozzle_base", m_NozzleBase, false)
	SIMDATA_DEF("jfs_off_rpm", m_JFSOffRPM, false)
	SIMDATA_DEF("start_drive", m_StartDrive, false)
	SIMDATA_DEF("normal_hang_time", m_NormalHangTime, false)
	SIMDATA_DEF("abnormal_hang_time", m_AbnormalHangTime, false)
	SIMDATA_DEF("hot_start_branch", m_HotStartBranch, false)
	SIMDATA_DEF("jfs_drive_factor", m_JFSDriveFactor, false)
	SIMDATA_DEF("fuel_pressurization_rate", m_FuelPressurizationRate, false)
	SIMDATA_DEF("fuel_depressurization_rate", m_FuelDepressurizationRate, false)
SIMDATA_XML_END
