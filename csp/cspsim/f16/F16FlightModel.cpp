...
CSP_XML_BEGIN(F16FlightModel)
	...
	CSP_DEF("cl_x_m", m_CL_x_m, true)

	CSP_DEF("cx_de_a_b", m_CX_de_a_b, true)
	CSP_DEF("cx_lef_a_b", m_CX_lef_a_b, true)
	CSP_DEF("cx_q_a", m_CX_q_a, true)
	CSP_DEF("cx_q_lef_a", m_CX_q_lef_a, true)
	CSP_DEF("cx_sb_a", m_CX_sb_a, true)
	CSP_DEF("cx_tef_a", m_CX_tef_a, true)

	CSP_DEF("cz_de_a_b", m_CZ_de_a_b, true)
	CSP_DEF("cz_lef_a_b", m_CZ_lef_a_b, true)
	CSP_DEF("cz_q_a", m_CZ_q_a, true)
	CSP_DEF("cz_q_lef_a", m_CZ_q_lef_a, true)
	CSP_DEF("cz_sb_a", m_CZ_sb_a, true)
	CSP_DEF("cz_tef_a", m_CZ_tef_a, true)

	CSP_DEF("cm_q_a", m_CM_q_a, true)
	CSP_DEF("cm_de_a", m_CM_de_a, true)
	CSP_DEF("cm_sb_a", m_CM_sb_a, true)
	CSP_DEF("cm_tef_a", m_CM_tef_a, true)

	CSP_DEF("cy_m", m_CY_m, true)
	CSP_DEF("cy_p_a", m_CY_p_a, true)
	CSP_DEF("cy_r_a", m_CY_r_a, true)
	CSP_DEF("cy_p_lef_a", m_CY_p_lef_a, true)
	CSP_DEF("cy_r_lef_a", m_CY_r_lef_a, true)
	CSP_DEF("cy_a_b", m_CY_a_b, true)
	CSP_DEF("cy_lef_a_b", m_CY_lef_a_b, true)
	CSP_DEF("cy_dr_a_b", m_CY_dr_a_b, true)
	CSP_DEF("cy_da_a_b", m_CY_da_a_b, true)
	CSP_DEF("cy_da_lef_a_b", m_CY_da_lef_a_b, true)

	CSP_DEF("ci_de_a_b", m_CI_de_a_b, true)
	CSP_DEF("ci_da_a_b", m_CI_da_a_b, true)
	CSP_DEF("ci_dr_a_b", m_CI_dr_a_b, true)
	CSP_DEF("ci_p_a", m_CI_p_a, true)
	CSP_DEF("ci_r_a", m_CI_r_a, true)

	CSP_DEF("cn_r_a", m_Cn_r_a, true)
	CSP_DEF("cn_r_lef_a", m_Cn_r_lef_a, true)
	CSP_DEF("cn_p_a", m_Cn_p_a, true)
	CSP_DEF("cn_p_lef_a", m_Cn_p_lef_a, true)
	CSP_DEF("cn_dr_a_b", m_Cn_dr_a_b, true)
	CSP_DEF("cn_da_a_b", m_Cn_da_a_b, true)
	CSP_DEF("cn_de_a_b", m_Cn_de_a_b, true)
	CSP_DEF("cn_da_lef_a_b", m_Cn_da_lef_a_b, true)
	CSP_DEF("cn_lef_a_b", m_Cn_lef_a_b, true)
CSP_XML_END
