...
double FuelSystem::onUpdate(double dt) {
...
double FuelSystem::drawFuel(double dt, double amount) {
...
double FuelSystem::refuel(double /*dt*/, double /*amount*/, bool /*ground*/) {
	return 0.0; // TODO implement me!
}

void FuelSystem::registerChannels(Bus *bus) {
...
void FuelSystem::updateFuelReadout() {
	double totalizer = 0;
	double al = 0;
	double fr = 0;
	totalizer =
