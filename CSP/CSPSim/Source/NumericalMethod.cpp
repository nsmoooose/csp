...
NumericalMethod::NumericalMethod(VectorField *pvf):
	...
	m_Name("Undefined numerical method!") {
		if (m_VectorField)
			...
			m_Dimension = 2;
			std::cout << "NumericalMethod: VectorField dimension undefined! (default is 2)\n";
		}
}
...
unsigned int const RungeKutta::MAXSTP = 8; // XXX WAS 8
...
double RKCK_VS_VO::rkck23(double a, double h, Vectord const &ystart) {
    static  double const c3 = 3.0/10.0, c4 = 3.0/5.0,
						a31 = 3.0/40.0, a32 = 9.0/40.0,
						a41 = 3.0/10.0, a42 = -9.0/10.0,   a43 = 6.0/5.0,
						b31 = 19.0/54.0, b33 = -10.0/27.0, b34 = 55.0/54.0,
						third = 1.0/3.0;
...
double RKCK_VS_VO::rkck45(double a, double h, Vectord const &ystart) {
    static  double const c6 = 7.0/8.0, // c5 = 1.0
						a51 = -11.0/54.0, a52 = 5.0/2.0, a53 = -70.0/27.0, a54 = 35.0/27.0,
						a61 = 1631.0/55296.0, a62 = 175.0/512.0, a63 = 575.0/13824.0, a64 = 44275.0/110592.0, 
						a65 = 253.0/4096.0,
						b41 = 2825.0/27648.0, b43 = 18575.0/48384.0, b44 = 13525.0/55296.0, b45 = 277.0/14336.0, 
						b46 = 1.0/4.0,
						b51 = 37.0/378.0, b53 = 250.0/621.0, b54 = 125.0/594.0, b56 = 512.0/1771.0;
#ifdef USE_VALARRAY_ARITHMETIC
...
Vectord const  &RKCK_VS_VO::vrkf(Vectord &ystart, double a, double h, double &hdid, double &hnext) {
    static  double const	third = 1.0/3.0, twothird = 2.0 * third,
							inv_eps2 = 1.0 / sqrt(m_Epsilon), inv_eps3 = 1.0   / pow(m_Epsilon,third), 
							inv_eps5 = 1.0 / pow(m_Epsilon,0.2);
...
Vectord const &RKCK_VS_VO::vrkfBound(Vectord &ystart, double a, double h, double h1, unsigned int &nok,
                                         unsigned int &nbad)    {
