#include "LinuxWindowText.h"
#include "stdlib.h"
#include "string.h"

LinuxWindowText::LinuxWindowText()
{
...
short LinuxWindowText::Initialize(StandardApp *App, StandardFramework *Framework)
{

  p_App = App;
  p_AppInit = p_App->GetInit();
...
void LinuxWindowText::Uninitialize()
{
...
void LinuxWindowText::PrintText(char *text)
{
  //  DWORD written;
...
bool LinuxWindowText::PreprocessInput(char*InputLine)
{
