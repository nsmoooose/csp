...
USAGE = """\
CSPSim layout tool generation script.
...
CSPLAYOUT_BIN = os.path.join(BASE, 'tools', 'layout2', '.bin')
...
modulefinder.AddPackagePath('csp.tools.layout2', CSPLAYOUT_BIN)
...
def make_demo(version):
	...
	TARGET = os.path.join(BASE, 'tools', 'layout2', 'layout.py')
	...
	setup(options=opts, windows=[windows], console=[TARGET], data_files=[CONFIG])
	...
	DATA_TARGET = os.path.join(DEMO, 'images')
	LAYOUT_DIR = os.path.join(BASE, 'tools', 'layout2')
