...
class CCXX_CLASS_EXPORT SHAConstant;
class CCXX_CLASS_EXPORT SHA64DigestHelper;
...
class CCXX_CLASS_EXPORT SHATumbler {
public:
	SHATumbler(int);
...
class CCXX_CLASS_EXPORT SHADigest : public Digest {
private:
