...
AC_DEFUN(OST_CC_SIGNAL,[
	...
	if test "$ac_cv_ost_sigwait2" = "yes" ; then
		AC_DEFINE(HAVE_SIGWAIT2)
	fi
])

dnl ACCONFIG TEMPLATE
dnl #undef HAVE_SIGWAIT2
dnl #undef HAVE_SIGACTION
dnl #undef HAVE_BSD_SIGNAL_H
dnl #undef HAVE_SETITIMER
dnl END ACCONFIG
 ...
 AC_REQUIRE([OST_CXX_PROGRAMMING])
  ...
  AC_ARG_WITH(stlport, [  --with-stlport[=dir]    using SGI portable C++ stream library
	...
	if test "$withval" = "" ; then
		CXXFLAGS="-I$(includedir)/stlport $CXXFLAGS"
	else
		CXXFLAGS="-I$withval/include/stlport $CXXFLAGS"
