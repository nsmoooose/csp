...
// not much point in creating a cpp file for these, and moving them
// out of the class declaration is convenient for simultaneously
// suppressing unknown parameter warnings generated by both the
