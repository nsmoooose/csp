...
// TODO use Exception subclasses, possibly replace with glib
...
ConfigError::ConfigError(const std::string &msg, const std::string &filename, int line_no, const std::string &line): Error(msg) {
	char lstr[20];
	m_filename = filename;
	m_line_no = line_no;
	m_line = line;
