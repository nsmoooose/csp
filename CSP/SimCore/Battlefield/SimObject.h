 ...
 *
 */
class SimObject: public simdata::Object, public UpdateTarget, public simnet::DispatchTarget
{
...
public:
	...
	virtual simdata::Path getObjectPath() const { return simdata::Path(getPath()); }
...
protected:
	...
	virtual void onNewContact(simdata::Ref<SimObject> const &/*contact*/) { }
	virtual void onLostContact(simdata::Ref<SimObject> const &/*contact*/) { }
	...
	virtual void setState(simdata::Ref<simnet::NetworkMessage> const &, simcore::TimeStamp /*now*/) { }
