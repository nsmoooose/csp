...
int CMipMapQuad::RenderQuad(int iStepTop, int iStepBottom, int iStepLeft, int iStepRight, bool bLines)
{
	...
	/*if (m_iCurSteps>2)
	{
		if (m_iCurSteps>iStepTop) m_iCurSteps = iStepTop<<1;
		if (m_iCurSteps>iStepBottom) m_iCurSteps = iStepBottom<<1;
		if (m_iCurSteps>iStepLeft) m_iCurSteps = iStepLeft<<1;
		if (m_iCurSteps>iStepRight) m_iCurSteps = iStepRight<<1;
	}*/
