...
void BaseDynamics::bindKinematics(simdata::Vector3 const &position_local, simdata::Vector3 const &velocity_body, 
...
void BaseDynamics::bindGroundParameters(bool const &near_ground, double const &height, simdata::Vector3 const &normal_ground) {
...
simdata::Vector3 BaseDynamics::getForce() const {
	return m_Force;
}

simdata::Vector3 BaseDynamics::getMoment() const {
	return m_Moment;
}