#ifndef __ENVIRONMENTALENTITY_H__
#define __ENVIRONMENTALENTITY_H__
...
class EnvironmentalEntity : public BaseEntity
{
  // Methods
 public:

  EnvironmentalEntity();
  virtual ~EnvironmentalEntity();

  EnvironmentalEntity(const EnvironmentalEntity &);
  EnvironmentalEntity & operator=(const EnvironmentalEntity &);
