...
#include <csp/lib/util/hash_map.h>
...
struct MemberValidator {
	 ...
	 *  required by the @c CSP_DEF macros, and the write flag indicates the
...
public:
	...
	typedef typename HashMap<std::string, MemberAccessorBase*>::Type map;
...
public:
	 ...
	 *
	 *  @note Do not call this method directly: use the CSP_XML()
	 *        macro instead.
	 */
	template<typename T>
