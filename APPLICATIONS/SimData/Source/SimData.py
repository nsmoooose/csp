...
class PyInterfaceProxy(cSimData.InterfaceProxy):
	...
	def createObject(self, disown=1):
		...
		# object in a PathPointer<>.  The PathPointer maintains its own
		...
		# wrap the object in a PathPointer<>, you will be responsible 
...
# Use unspecialized version in Python
PathPointer = PathPointerBase
